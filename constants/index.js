...
export const TOGGLE_PROJECT_PANE = 'TOGGLE_PROJECT_PANE';
export const REMOVE_ASANA_TOKEN = 'REMOVE_ASANA_TOKEN';
export const ADD_ASANA_TOKEN = 'ADD_ASANA_TOKEN';
export const TOGGLE_ASANA_MESSAGE = 'TOGGLE_ASANA_MESSAGE';